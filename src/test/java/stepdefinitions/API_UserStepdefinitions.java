...
public class API_UserStepdefinitions {
    ...
    @And("The API user saves the response returned from the user ticket list endpoint and verifies that the status code is '400'")
    public void theAPIUserSavesTheResponseReturnedFromTheUserTicketListEndpointAndVerifiesThatTheStatusCodeIs() {
        assertTrue(ReusableMethods.tryCatchPatch("user").contains("status code: 400"));
    }
    ...
    public void theAPIUserSavesTheResponseReturnedFromTheUserTicketDeleteEndpointAndVerifiesThatTheStatusCodeIs() {
        assertTrue(ReusableMethods.tryCatchDelete("user").contains("status code: 400"));
    }
    //*************************************************************************************************
    ...
    public void theAPIUserSavesTheResponseReturnedFromTheUserProfileEndpointAndVerifiesThatTheStatusCodeIs() {
    ...
    public void theAPIUserSavesTheResponseReturnedFromTheUserChangePasswordEndpointAndVerifiesThatTheStatusCodeIs() {
        Assert.assertTrue(ReusableMethods.tryCatchPatchBody("user",requestBody.toString()).contains("status code: 422"));
    }

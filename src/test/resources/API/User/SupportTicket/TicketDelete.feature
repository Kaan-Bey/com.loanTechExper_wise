Feature: As a user, I should be able to delete a user ticket record in the system through API connection.
  ...
  user/ticket/delete/{{id}} endpoint, the returned status code should be 203, and the message in
  ...
  sent to the user/ticket/delete/{{id}} endpoint, the returned status code should be 203, and the message
